...
module WorldExtensions =
    ...
    type World with
        ...
        member this.hasScore
            with get() = not(this.scoreEntity.IsNull())
        ...
        member this.hasMouse
            with get() = not(this.mouseEntity.IsNull())
        ...
        member this.isFiring
            with get() =
                not(this.firingEntity.IsNull())
            and  set(value) =
                let entity = this.firingEntity
                if value <> not(entity.IsNull()) then
                    if value then
        ...
        member this.hasStatus
            with get() = not(this.statusEntity.IsNull())
